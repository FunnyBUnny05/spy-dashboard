...
- **F2 `src/components/StrategyPanel.tsx`** — Added TWO(30,80) to chart, risk-comparison table, live metrics table, and a current-stance card. Caption explains tradeoff vs 5-Tier. Does not remove fiveTier.

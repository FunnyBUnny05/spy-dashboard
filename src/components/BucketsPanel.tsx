    ...
    <div className="two-col">
      ...
      <div>
        <div className="chart-box">
          <div className="chart-title">
            <span>Walk-forward sign-constrained Ridge forecast (v5.3, n=120)</span>
        ...
        <div style={{ fontSize: 10, color: 'var(--text3)', marginTop: 6, lineHeight: 1.45 }}>
          ...
          under the v5.3 sign-constrained ridge (α=5), so Q1 and Q5 may be thinly populated or empty.
      ...
      <div className="chart-box">
        ...
        <div style={{ fontSize: 10, color: 'var(--text3)', marginTop: 12 }}>
          v5.3 sign-constrained Ridge · OOS Spearman ρ = 0.560 · residual std = 11.3% · α=5 (auto-prunes 3 redundant signals)
        </div>
      </div>
    </div>
  );

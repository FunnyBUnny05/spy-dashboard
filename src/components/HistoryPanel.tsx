  ...
  return (
    <>
      ...
      <div className="callout callout-info">
        <strong>v5.7 sign-constrained Ridge model</strong> — solid line is walk-forward out-of-sample
        (n=136, ρ=0.488). Dashed segments are <em>in-sample</em> scores from the final

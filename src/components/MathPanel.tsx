  ...
  return (
    <div className="two-col">
      <div className="chart-box">
        <div className="chart-title"><span>v5.3 — Ridge regression · signal contributions</span></div>
        <table>
          <thead>
            <tr>
              <th>Signal</th>
      ...
      <div className="chart-box">
        <div className="chart-title"><span>v5.3 model summary</span></div>
        <table>
          <thead>
            <tr>
              <th>Parameter</th>
        ...
        <div className="callout callout-info" style={{ marginTop: 16, fontSize: 11 }}>
          <strong>v5.3 methodology:</strong> Rank-Gauss normalise all 7 signals
          → sign-constrained Ridge (α={ALPHA}, fixed) — coefficients forced to share sign with univariate ρ.
          The constraint auto-prunes 3 redundant signals (MFI, EMA dist, Margin Debt) by zeroing them.
          Effective model uses 4 active features
